...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		dayNamesMin: [ "일", "월", "화", "수", "목", "금", "토" ], // 주일 표시
		weekHeader: "Wk", // Column header for week of the year
		dateFormat: "yy-mm-dd", // 연월일 출력라인
		firstDay: 1, // The first day of the week, Sun = 0, Mon = 1, ...
		isRTL: false, // True if right-to-left language, false if left-to-right
		showMonthAfterYear: true, // 연도와 위치를 변경함
		yearSuffix: "년", // 년도 뒤에 사용할 단어
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		showAnim: "show", // 달력 출력시 사용되는 애니메이션
		...
		changeMonth: false, // True if month can be selected directly, false if only prev/next 월 교체
		changeYear: false, // True if year can be selected directly, false if only prev/next 년도 교체
