...
public class ServiceSMSLocator extends org.apache.axis.client.Service implements test.ServiceSMS {
    ...
    private java.lang.String ServiceSMSSoap_address = "http://webservice.tongkni.co.kr/SMS.3/ServiceSMS.asmx";
    ...
    public test.ServiceSMSSoap getServiceSMSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.ServiceSMSSoapStub _stub = new test.ServiceSMSSoapStub(portAddress, this);
    ...
    private java.lang.String ServiceSMSSoap12_address = "http://webservice.tongkni.co.kr/SMS.3/ServiceSMS.asmx";
    ...
    public test.ServiceSMSSoap getServiceSMSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.ServiceSMSSoap12Stub _stub = new test.ServiceSMSSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.ServiceSMSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                test.ServiceSMSSoapStub _stub = new test.ServiceSMSSoapStub(new java.net.URL(ServiceSMSSoap_address), this);
                _stub.setPortName(getServiceSMSSoapWSDDServiceName());
                return _stub;
            }
            if (test.ServiceSMSSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                test.ServiceSMSSoap12Stub _stub = new test.ServiceSMSSoap12Stub(new java.net.URL(ServiceSMSSoap12_address), this);
                _stub.setPortName(getServiceSMSSoap12WSDDServiceName());
                return _stub;
            }
        }
